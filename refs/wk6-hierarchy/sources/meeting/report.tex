...
\begin{table}[h!]
\centering
\caption{Scaling exponent of the NTK correction w.r.t. Depth (L).}
\label{tab:slopes_l}
\resizebox{0.9\textwidth}{!}{%
\begin{tabular}{l | c | c | c}
\toprule
\textbf{Configuration} & \textbf{Slope} & \textbf{R²} & \textbf{Points} \\
\midrule
N=8, D\_IN=20, M=10 & 1.129 & 0.886 & 29 \\
N=10, D\_IN=50, M=10 & 1.087 & 0.992 & 22 \\
N=16, D\_IN=20, M=20 & 1.137 & 0.991 & 19 \\
N=8, D\_IN=20, M=40 & 1.113 & 0.989 & 17 \\
N=10, D\_IN=50, M=20 & 1.123 & 0.983 & 17 \\
N=64, D\_IN=20, M=10 & 1.196 & 0.986 & 14 \\
N=8, D\_IN=200, M=20 & 1.126 & 0.993 & 12 \\
N=8, D\_IN=20, M=50 & 1.112 & 0.988 & 12 \\
N=8, D\_IN=50, M=2000 & 1.171 & 0.992 & 9 \\
N=8, D\_IN=50, M=1000 & 1.159 & 0.994 & 9 \\
N=32, D\_IN=50, M=20 & 1.239 & 0.988 & 9 \\
N=32, D\_IN=20, M=200 & 1.248 & 0.983 & 9 \\
N=16, D\_IN=20, M=100 & 1.240 & 0.991 & 9 \\
N=8, D\_IN=20, M=200 & 1.169 & 0.992 & 9 \\
N=8, D\_IN=100, M=200 & 1.166 & 0.993 & 9 \\
N=8, D\_IN=20, M=2000 & 1.181 & 0.992 & 9 \\
N=8, D\_IN=20, M=60 & 1.245 & 0.993 & 7 \\
N=25, D\_IN=100, M=10 & 1.276 & 0.989 & 7 \\
N=8, D\_IN=1000, M=10 & 1.204 & 0.994 & 7 \\
N=32, D\_IN=50, M=200 & 1.330 & 0.990 & 6 \\
N=64, D\_IN=20, M=100 & 1.355 & 0.984 & 6 \\
N=32, D\_IN=100, M=20 & 1.440 & 0.993 & 4 \\
N=64, D\_IN=100, M=10 & 1.476 & 0.991 & 4 \\
N=64, D\_IN=50, M=20 & 1.460 & 0.990 & 4 \\
N=16, D\_IN=50, M=2000 & 1.381 & 0.994 & 4 \\
N=32, D\_IN=200, M=10 & 1.439 & 0.993 & 4 \\
\bottomrule
\end{tabular}}
\end{table}
...
\begin{table}[h!]
\centering
\caption{Scaling exponent of the NTK correction w.r.t. Data Size (N).}
\label{tab:slopes_n}
\resizebox{0.9\textwidth}{!}{%
\begin{tabular}{l | c | c | c}
\toprule
\textbf{Configuration} & \textbf{Slope} & \textbf{R²} & \textbf{Points} \\
\midrule
D\_IN=20, L=2, M=10 & 0.847 & 0.992 & 10 \\
D\_IN=20, L=4, M=20 & 0.888 & 0.998 & 8 \\
D\_IN=50, L=2, M=10 & 0.821 & 0.997 & 8 \\
D\_IN=20, L=8, M=20 & 0.933 & 0.998 & 7 \\
D\_IN=20, L=6, M=30 & 0.871 & 0.993 & 6 \\
D\_IN=50, L=12, M=10 & 0.967 & 0.974 & 6 \\
D\_IN=20, L=12, M=20 & 0.915 & 1.000 & 6 \\
D\_IN=20, L=2, M=30 & 0.771 & 0.995 & 6 \\
D\_IN=50, L=18, M=10 & 0.904 & 0.999 & 6 \\
D\_IN=50, L=20, M=10 & 0.912 & 0.995 & 5 \\
D\_IN=20, L=30, M=10 & 0.863 & 1.000 & 5 \\
D\_IN=20, L=14, M=30 & 0.911 & 0.998 & 5 \\
D\_IN=50, L=10, M=20 & 0.880 & 1.000 & 5 \\
D\_IN=50, L=4, M=30 & 0.841 & 0.999 & 5 \\
D\_IN=100, L=2, M=20 & 0.739 & 0.998 & 5 \\
D\_IN=50, L=26, M=10 & 0.871 & 0.999 & 4 \\
D\_IN=20, L=6, M=200 & 0.898 & 0.999 & 4 \\
D\_IN=20, L=6, M=40 & 0.838 & 0.997 & 4 \\
D\_IN=200, L=8, M=10 & 0.877 & 0.999 & 4 \\
D\_IN=50, L=28, M=10 & 0.892 & 0.999 & 4 \\
D\_IN=20, L=2, M=500 & 0.790 & 0.996 & 4 \\
D\_IN=50, L=8, M=100 & 0.904 & 0.999 & 4 \\
\bottomrule
\end{tabular}}
\end{table}
